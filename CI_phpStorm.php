 ...
 * @property CI_Utf8 $utf8                        Provides support for UTF-8 environments
 * @property CI_Security $security                Security Class, xss, csrf, etc...
 * @property kardex_model $kardex_model           kardex_model
 * @property inventario_model $inventario_model           inventario_model
 * @property unidades_model $unidades_model           unidades_model
 * @property ajusteinventario_model $ajusteinventario_model           ajusteinventario_model
 * @property producto_model $producto_model           producto_model
 * @property venta_model $venta_model           venta_model
 * @property detalleingreso_especial_model $detalleingreso_especial_model           detalleingreso_especial_model
 * @property paquete_has_prod_model $paquete_has_prod_model           paquete_has_prod_model
 */
class CI_Model{}
