...
<div class="row bg-title">
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title">Grupos de usuarios</h4></div>
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="white-box">
            ...
            <a class="btn btn-primary" onclick="Roles.add();">
                <i class="fa fa-plus "> Nueva</i>
            </a>
            <br>

            <div class="table-responsive">
                <table class="table table-striped dataTable table-bordered" id="TABLAROLES">
                    <thead>
                    <tr>
                                ...
                                <td class="center">
                                    <div class="btn-group">
                                        ...
                                        echo '<a class="btn btn-default" data-toggle="tooltip"
                                            ...
                                            href="#" onclick="Roles.edit(' . $grupo['id_grupos_usuarios'] . ');">'; ?>
                                        <i class="fa fa-edit"></i>
                                        </a>
                                        <?php echo '<a class="btn btn-default" data-toggle="tooltip"
                                     title="Eliminar" data-original-title="fa fa-comment-o"
                                     onclick="Roles.delete(' . $grupo['id_grupos_usuarios'] . ',\'' . $grupo['nombre_grupos_usuarios'] . '\');">'; ?>
...
<script>$(function () {
        ...
        TablesDatatables.init(0,'TABLAROLES');
