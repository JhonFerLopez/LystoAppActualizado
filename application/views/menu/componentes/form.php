<form name="formagregar" action="<?= base_url() ?>componentes/guardar" method="post" id="formagregar">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <div class="col-md-10"><input type="text" name="nombre" id="nombre" required="true" class="form-control"
                                                  value="<?php if (isset($componente['componente_nombre'])) echo $componente['componente_nombre']; ?>">
                    </div>

                    <input type="hidden" name="id" id="" required="true"
                           value="<?php if (isset($componente['componente_id'])) echo $componente['componente_id']; ?>">
                </div>
            </div>
