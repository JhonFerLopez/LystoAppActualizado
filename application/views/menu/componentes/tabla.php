    ...
    <div class="col-md-12">
                    ...
                    <?php if (count($marcas) > 0) {
                        ...
                        foreach ($marcas as $marca) {
                            ...
                            <tr>
                                ...
                                <td class="center"><?= $marca['componente_id'] ?></td>
                                <td><?= $marca['componente_nombre'] ?></td>
                                ...
                                <td class="center">
                                    <div class="btn-group">
                                        ...
                                        echo '<a class="btn btn-default" data-toggle="tooltip"
                                            ...
                                            href="#" onclick="editargrupo(' . $marca['componente_id'] . ');">'; ?>
                                        <i class="fa fa-edit"></i>
                                        </a>
                                        <?php echo '<a class="btn btn-default" data-toggle="tooltip"
                                     title="Eliminar" data-original-title="fa fa-comment-o" onclick="borrargrupo(' . $marca['componente_id'] . ',\'' . $marca['componente_nombre'] . '\');">'; ?>
        ...
        <script type="text/javascript">
            ...
            function editargrupo(id) {
                $("#agregargrupo").load('<?= $ruta ?>componentes/form/' + id);
                $('#agregargrupo').modal('show');
            }

            function agregargrupo() {

                $("#agregargrupo").load('<?= $ruta ?>componentes/form');
                $('#agregargrupo').modal('show');
            }
