...
<div class="row bg-title">
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title">Productos con menor rotaci&oacute;n</h4></div>
            ...
            <div class="table-responsive" id="">
                <table class="table table-striped dataTable table-bordered" id="tabla">
                    ...
                    <tr>
                        ...
                        <th>Nombre</th>
                        <th>D&iacute;as sin rotacion</th>
                        <?php foreach ($unidades as $unidad): ?>
                            <th>Stock <?= $unidad['abreviatura']?></th>
...
<script type="text/javascript">
    ...
    function get_datos() {
        ...
        TablesDatatablesLazzy.init('<?php echo $ruta ?>reportes/dataRepProdSinRotacion', 0, 'tabla', {
