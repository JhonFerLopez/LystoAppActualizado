...
<div class="row bg-title">
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title">Ubicación física</h4></div>
                    ...
                    <?php if (count($marcas) > 0) {
                        ...
                        foreach ($marcas as $marca) {
                            ...
                            <tr>
                                ...
                                <td class="center"><?= $marca['ubicacion_id'] ?></td>
                                <td><?= $marca['ubicacion_nombre'] ?></td>
                                ...
                                <td class="center">
                                    <div class="btn-group">
                                        ...
                                        echo '<a class="btn btn-default" data-toggle="tooltip"
                                            ...
                                            href="#" onclick="editargrupo(' . $marca['ubicacion_id'] . ');">'; ?>
                                        <i class="fa fa-edit"></i>
                                        </a>
                                        <?php echo '<a class="btn btn-default" data-toggle="tooltip"
                                     title="Eliminar" data-original-title="fa fa-comment-o" onclick="borrargrupo(' . $marca['ubicacion_id'] . ',\'' . $marca['ubicacion_nombre'] . '\');">'; ?>
...
<script type="text/javascript">
    ...
    function editargrupo(id) {
        $("#agregargrupo").load('<?= $ruta ?>ubicacion_fisica/form/' + id);
        $('#agregargrupo').modal('show');
    }

    function agregargrupo() {

        $("#agregargrupo").load('<?= $ruta ?>ubicacion_fisica/form');
        $('#agregargrupo').modal('show');
    }
...
<div class="modal fade" id="borrar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    <form name="formeliminar" id="formeliminar" method="post" action="<?= $ruta ?>ubicacion_fisica/eliminar">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title">Eliminar ubicación física</h4>
                </div>
                <div class="modal-body">
                    <p>Est&aacute; seguro que desea eliminar la ubicación física?</p>
