...
<div class="row bg-title">
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title">Régimen contributivo</h4></div>
...
<div class="block">
    ...
    <div class="table-responsive">
        <table class="table table-striped dataTable table-bordered" id="example">
            ...
            <tbody>
            <?php if (count($regimenes) > 0) {

                foreach ($regimenes as $regimen) {
                    ?>
                    <tr>

                        <td class="center"><?= $regimen['regimen_id'] ?></td>
                        <td><?= $regimen['regimen_nombre'] ?></td>
                        ...
                        <td class="center">
                            <div class="btn-group">
                                ...
                                echo '<a class="btn btn-default" data-toggle="tooltip"
                                            ...
                                            href="#" onclick="editarempresa(' . $regimen['regimen_id'] . ');">'; ?>
                                <i class="fa fa-edit"></i>
                                </a>
                                <?php echo '<a class="btn btn-default" data-toggle="tooltip"
                                     title="Eliminar" data-original-title="fa fa-comment-o" onclick="borrarempresa(' . $regimen['regimen_id'] . ',\'' . $regimen['regimen_nombre'] . '\');">'; ?>
...
<script type="text/javascript">
    ...
    function editarempresa(id) {
        ...
        $.ajax({
            ...
            error: function (error) {
                ...
                Utilities.alertModal('<h4> Ha ocurrido un error</h4>');
    ...
    var objeto = {
        ...
        guardar: function () {
            ...
            if ($("#regimen_nombre").val() == '') {
                var growlType = 'warning';
                Utilities.alertModal('<h4> Debe ingresar el nombre</h4>');
...
<div class="modal fade" id="borrar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    <form name="formeliminar" id="formeliminar" method="post" action="<?= $ruta ?>regimen/eliminar">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="regimen_id" id="id_borrar">
                    <input type="hidden" name="regimen_nombre" id="nom_borrar">
                </div>
                <div class="modal-footer">
