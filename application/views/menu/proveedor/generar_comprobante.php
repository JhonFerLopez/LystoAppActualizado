...
<div class="row bg-title">
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title">Comprobantes de egreso</h4></div>
                ...
                <div class="block-section block-alt-noborder">
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            ...
                            <select name="cboProveedor" id="cboProveedor" class='form-control select-chosen'
                                    onchange="CuentasPorPagar.buscarRecibos()">
                                <option value="-1">Seleccionar</option>
                                <?php if (count($lstproveedor) > 0): ?>
                                    <?php foreach ($lstproveedor as $pr): ?>
                                        <option
                                                value="<?php echo $pr['id_proveedor']; ?>"><?php echo $pr['proveedor_nombre']; ?></option>
                                    <?php endforeach; ?>
                                <?php else : ?>
                                <?php endif; ?>
                            </select>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-6"><input class="form-control" name="observaciones_adicionales"
                                                         id="observaciones_adicionales"/></div>
                            <div class="col-md-6">Tipo de pago</div>
                            <div class="col-md-6"><select class="form-control select-chosen" name="metodo" id="metodo"
                                                          onchange="CuentasPorPagar.toogleBanco()">
                ...
                <div class="row">
                    ...
                    <div class="col-md-1">
                        <button type="button" class="btn btn-success" id="guardarPago"
                                onclick="CuentasPorPagar.guardarPago()">
                            Aceptar
                        </button>
                    </div>
                    <div class="col-md-1">
...
<script type="text/javascript">
    $('document').ready(function () {
        CuentasPorPagar.init(<?php echo json_encode($metodos);?>);
    });
</script>