        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"><a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
                <div class="top-left-part"><a class="logo" href="#"><b>
                        ...
                        </b><span class="hidden-xs"><strong>SID</strong><?= $imglogo ?></span></a></div>
...
<div class="modal fade" id="mvisualizarVenta" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
</div>
...
<div class="modal fade" id="catalogo_template" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
</div>
...
<div id="alertbottom" class="myadmin-alert myadmin-alert-icon myadmin-alert-click alert-warning myadmin-alert-bottom alertbottom"><i class="ti-user"></i> Hay cajas abiertas. Debe amarrar sus ventas a una de las cajas abiertas o aperturar una
    caja <a href="#" class="closed">×</a></div>

<div id="alertbottom2" class="myadmin-alert myadmin-alert-icon myadmin-alert-click alert-warning myadmin-alert-bottom alertbottom2"><i class="ti-user"></i>Atención. No hay cajas abiertas. Debes aperturar una caja para vender <a href="#" class="closed">×</a>
</div>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body" id="">
                <div class="row">
                    <div class="col-md-3">
                        <div id="tabacatalogo_filter" class="dataTables_filter"><label>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <h2>Est&aacute; seguro que quiere enviar este mensaje a todos los usuarios?
                                Si est&aacute; de acuerdo, presione confirmar</h2>
                        ...
                        <div class="modal-footer">
                            ...
                            <div class="text-left col-md-2" id="">
                                <a href="#" class="btn btn-primary" style="text-align: left" onclick="Notificaciones.confirmSendMsj()">Confirmar</a></div>
