...
<div class="row bg-title">
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title">Clasificaciones</h4></div>
                        ...
                        <?php if (count($marcas) > 0) {
                            ...
                            foreach ($marcas as $marca) {
                                ...
                                <tr>
                                    ...
                                    <td class="center"><?= $marca['clasificacion_id'] ?></td>
                                    <td><?= $marca['clasificacion_nombre'] ?></td>
                                    ...
                                    <td class="center">
                                        <div class="btn-group">
                                            ...
                                            href="#" onclick="editargrupo(' . $marca['clasificacion_id'] . ');">'; ?>
                                            <i class="fa fa-edit"></i>
                                            </a>
                                            <?php echo '<a class="btn btn-default" data-toggle="tooltip"
                                     title="Eliminar" data-original-title="fa fa-comment-o" onclick="borrargrupo(' . $marca['clasificacion_id'] . ',\'' . $marca['clasificacion_nombre'] . '\');">'; ?>
...
<script type="text/javascript">
    ...
    function editargrupo(id) {
        $("#agregargrupo").load('<?= $ruta ?>clasificacion/form/' + id);
        $('#agregargrupo').modal('show');
    }

    function agregargrupo() {

        $("#agregargrupo").load('<?= $ruta ?>clasificacion/form');
        $('#agregargrupo').modal('show');
    }
...
<div class="modal fade" id="borrar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    <form name="formeliminar" id="formeliminar" method="post" action="<?= $ruta ?>clasificacion/eliminar">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Est&aacute; seguro que desea eliminar la clasificación seleccionada</p>
