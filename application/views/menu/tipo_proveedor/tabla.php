...
<div class="row bg-title">
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title">Tipo proveedor</h4></div>
...
<div class="row">
    ...
    <div class="col-md-12">
                    ...
                    <?php if (count($tipos) > 0) {
                        ...
                        foreach ($tipos as $tipo) {
                            ...
                            <tr>
                                ...
                                <td class="center"><?= $tipo['tipo_proveedor_id'] ?></td>
                                <td><?= $tipo['tipo_proveedor_nombre'] ?></td>
                                ...
                                <td class="center">
                                    <div class="btn-group">
                                        ...
                                        echo '<a class="btn btn-default" data-toggle="tooltip"
                                            ...
                                            href="#" onclick="editar(' . $tipo['tipo_proveedor_id'] . ');">'; ?>
                                        <i class="fa fa-edit"></i>
                                        </a>
                                        <?php echo '<a class="btn btn-default" data-toggle="tooltip"
                                     title="Eliminar" data-original-title="fa fa-comment-o" onclick="borrarempresa(' . $tipo['tipo_proveedor_id'] . ',\'' . $tipo['tipo_proveedor_nombre'] . '\');">'; ?>
        ...
        <script type="text/javascript">
            ...
            function editar(id) {
              ...
              Utilities.showPreloader();
                ...
                $.ajax({
                    url: '<?= $ruta ?>tipo_proveedor/form/' + id,
                    type: 'post',
            ...
            var objeto = {
                ...
                guardar: function () {
                    ...
                    if ($("#tipo_proveedor_nombre").val() == '') {

                        Utilities.alertModal("Debe ingresar el nombre", "warning");
        ...
        <div class="modal fade" id="borrar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
             aria-hidden="true">
            <form name="formeliminar" id="formeliminar" method="post" action="<?= $ruta ?>tipo_proveedor/eliminar">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;
                            </button>
                            <h4 class="modal-title">Eliminar tipo de provedor</h4>
                        </div>
                        <div class="modal-body">
                            <p>Est&aacute; seguro que desea eliminar?</p>
                            <input type="hidden" name="tipo_proveedor_id" id="id_borrar">
                            <input type="hidden" name="tipo_proveedor_nombre" id="nom_borrar">
                        </div>
                        <div class="modal-footer">
