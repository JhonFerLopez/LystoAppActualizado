...
<table>
    <tr>
        <td style="" class="title"
            colspan="9">LISTA DE PAGO PENDIENTES
        </td>
    </tr>
    <tr>
        <td width="12%">&nbsp;&nbsp;</td>
...
<table>
    <tr>
        ...
        <th class='tip' title="Monto Cancelado">Por confirmar <?php echo MONEDA ?></th>
    ...
    <?php if (count($lstVenta) > 0):
        ...
        <tr>
            ...
            <td style="text-align: center;"><?php if ($v['var_credito_estado'] == CREDITO_ACUENTA) {
                    ...
                    echo utf8_encode("Canceló");
                } elseif ($v['var_credito_estado'] == CREDITO_DEBE) {
                    echo "DB";
                } else {
                    echo utf8_encode("Nota de Crédito");
                } ?></td>
