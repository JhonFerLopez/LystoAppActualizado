...
class documento_inventario_model extends CI_Model
{

	private $table = 'documentos_inventarios';
	private $nombre = 'documento_nombre';
	private $id = 'documento_id';
	private $documento_tipo = 'documento_tipo';
	...
	{
		$this->db->where($this->deleted, NULL);
		$this->db->where($array);
		$query = $this->db->get($this->table);
		return $query->result_array();
	}
