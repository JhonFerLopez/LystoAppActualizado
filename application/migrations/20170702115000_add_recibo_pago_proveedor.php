...
class Migration_Add_recibo_pago_proveedor extends CI_Migration
{
    public function up()
    {
        ...
        $this->dbforge->add_field('CONSTRAINT FOREIGN KEY (metodo_pago) REFERENCES metodos_pago(id_metodo)');

        $attributes = array('ENGINE' => 'InnoDB');
        $this->dbforge->create_table('recibo_pago_proveedor', true, $attributes);
    }

    public function down()
    {
        $this->dbforge->drop_table('recibo_pago_proveedor');
    }
}