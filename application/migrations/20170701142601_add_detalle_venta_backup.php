...
class Migration_Add_detalle_venta_backup extends CI_Migration
{
    public function up()
    {
        ...
        $this->dbforge->create_table('detalle_venta_backup', true, $attributes);
    }

    public function down()
    {
        $this->dbforge->drop_table('detalle_venta_backup');
    }
}