...
class Migration_Add_venta extends CI_Migration
{
    public function up()
    {
        ...
        $this->dbforge->add_field('CONSTRAINT FOREIGN KEY (caja_id) REFERENCES status_caja(id)');
        ...
        $this->dbforge->create_table('venta', true, $attributes);
    }

    public function down()
    {
        $this->dbforge->drop_table('venta');
    }
}